...
const updatesData = [
  "Обновление магазина",
  "Голосование в постах",
    "Новый раздел «Уведомления» (Beta)",

  "Исправлены баги в работе сайта",
    "-----------------------------------",
 ...
 news: (
  <Paper elevation={0} sx={paperStyle}>
    ...
    versions: (
      <Paper elevation={0} sx={paperStyle}>
        <DragIndicatorIcon sx={{ position: 'absolute', top: 12, right: 12, color: '#4b5563' }} />
        <Typography sx={{ fontWeight: 800, fontSize: '0.95rem', color: '#fff', mb: 2 }}>Обновление 15.5 ( 21.07.26 ) </Typography>
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
